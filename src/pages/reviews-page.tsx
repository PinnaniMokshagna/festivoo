  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        {[
          { label: 'Average Score', value: avgRating, accent: 'text-gold-700' },
          { label: 'Total Reviews', value: String(reviewsList.length + 300), accent: 'text-dark-900' },
          { label: '5-Star Ratings', value: String(fiveStarCount + 280), accent: 'text-sage-700' },
