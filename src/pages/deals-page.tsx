    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        {[
          ...
          { label: 'Redemptions', value: '64', icon: TrendingUp, color: 'text-gold-600', bg: 'bg-gold-50' },
          { label: 'Avg. Savings', value: '18%', icon: Percent, color: 'text-dark-700', bg: 'bg-dark-100' },
