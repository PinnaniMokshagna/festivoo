  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        {[
          { label: 'Total Revenue', value: `₹${totalRevenue.toLocaleString('en-IN')}`, change: '+24%', trend: 'up', bg: 'bg-gradient-brand', text: 'text-white' },
          { label: 'This Week', value: '₹2,76,000', change: '+18%', trend: 'up', bg: 'bg-card', text: 'text-dark-900' },
          { label: 'Pending Bookings', value: '₹1,20,000', change: '2 pending', trend: 'down', bg: 'bg-card', text: 'text-dark-900' },
          { label: 'Verified Payouts', value: '₹5,50,000', change: 'Instant UPI', trend: 'up', bg: 'bg-card', text: 'text-dark-900' },
        ].map((stat, i) => (
          <motion.div
            key={stat.label}
